...
export let supportsImportMaps = HTMLScriptElement.supports ? HTMLScriptElement.supports('importmap') : false, supportsImportMeta = supportsImportMaps;

export const featureDetectionPromise = (async () => {
  if (await supportsDynamicImportCheck) {

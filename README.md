...
```html
<!-- UNPKG -->
<script async src="https://unpkg.com/es-module-shims@0.12.4/dist/es-module-shims.js"></script>

<!-- JSPM.IO -->
<script async src="https://ga.jspm.io/npm:es-module-shims@0.12.4/dist/es-module-shims.js"></script>
```

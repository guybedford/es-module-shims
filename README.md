...
```html
<script async src="https://ga.jspm.io/npm:es-module-shims@2.8.4/dist/es-module-shims.js"></script>
...
`WebAssembly.namespaceInstance` is provided when not implemented natively, returning the underlying `WebAssembly.Instance` for a Wasm module namespace, currently supported for namespaces obtained through dynamic import.
